...
class SquatRepCounterConfig:
    down_thresh: float = 100.0  # Maximum knee angle to be considered as down
    up_thresh: float = 140.0  # Minimum knee angle to be considered as up
    min_bottom_frames: int = 2  # Minimum number of frames to stay in the bottom position
    min_top_frames: int = 2  # Minimum number of frames to stay in the top position
